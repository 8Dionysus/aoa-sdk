...
CONFIG = ROOT / "config/agon_retention_rank_sdk_helpers.seed.json"
OUTPUT = ROOT / "generated/agon_retention_rank_sdk_helpers.min.json"
...
def build_registry():
    ...
    return {
        ...
        "source_config": "config/agon_retention_rank_sdk_helpers.seed.json",
