...
```bash
aoa recur agents readiness --root /srv/workspace --json
aoa recur agents boundary-check --root /srv/workspace --json
aoa recur agents projection-candidates --root /srv/workspace --json
```
...
python scripts/recursor_agent_readiness.py projection-candidates --workspace-root /srv/workspace --json
```
