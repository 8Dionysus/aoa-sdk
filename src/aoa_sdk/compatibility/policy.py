...
SURFACE_COMPATIBILITY_RULES = {
    ...
    "aoa-skills.agent_skill_catalog": SurfaceCompatibilityRule(
        surface_id="aoa-skills.agent_skill_catalog",
        repo="aoa-skills",
        relative_path="generated/agent_skill_catalog.json",
        ...
        required_top_level_object_keys=["source_of_truth"],
    ),
    "aoa-skills.skill_pack_profiles.resolved": SurfaceCompatibilityRule(
        surface_id="aoa-skills.skill_pack_profiles.resolved",
        repo="aoa-skills",
        relative_path="generated/skill_pack_profiles.resolved.json",
        version_field="schema_version",
        supported_versions=[2],
        required_top_level_keys=["profile", "source_config", "profiles"],
        required_top_level_object_keys=["profiles"],
    ),
    "aoa-skills.capability_graph": SurfaceCompatibilityRule(
        surface_id="aoa-skills.capability_graph",
        repo="aoa-skills",
        relative_path="generated/capability_graph.json",
        version_field="schema_version",
        supported_versions=["aoa-capability-graph-v1"],
        required_top_level_keys=[
            "authority",
            "source",
            "roots",
        ...
        required_top_level_object_keys=["source"],
    ),
    "aoa-skills.portable_export_map": SurfaceCompatibilityRule(
        surface_id="aoa-skills.portable_export_map",
        repo="aoa-skills",
        relative_path="generated/portable_export_map.json",
    ...
    "aoa-skills.mcp_dependency_manifest": SurfaceCompatibilityRule(
        surface_id="aoa-skills.mcp_dependency_manifest",
        repo="aoa-skills",
        relative_path="generated/mcp_dependency_manifest.json",
        version_field="schema_version",
        supported_versions=[2],
        required_top_level_keys=["profile", "skills"],
    ),
