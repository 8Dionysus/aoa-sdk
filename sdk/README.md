...
- `sdk/facade-boundary/` for sibling-reader, compatibility, and truth-label
  boundaries.
- `sdk/runtime-entry/` for workspace, Codex, explicit Runner lifecycle, and
  reviewed checkpoint evidence entry posture.
...
| Runner entrypoints | `sdk/runtime-entry/runner-entrypoints/` | explicit-adapter lifecycle client and no-execution reference witness |
