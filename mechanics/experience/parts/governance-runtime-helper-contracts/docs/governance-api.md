# Experience Governance Api

Status: seed v0.8.0  
Repo landing: `aoa-sdk`  
Layer: Experience Polis Governance

## Purpose

Typed SDK helpers for governance cases, council sessions and decisions.
...
- aoa-sdk receives only bounded governance surfaces.
