...
def test_closeout_request_and_runtime_receipt_keep_canonical_mapping() -> None:
    ...
    publication_plan = plan_owner_publications(
        runtime_receipt_paths=["/srv/receipts/runtime_return_closeout_receipt.json"],
    ...
    assert request["batches"][0]["publisher"] == "abyss-stack.runtime-return-closeouts"
    assert receipt["event_kind"] == "runtime_return_closeout_receipt"
