...
This note records the control-plane helper slice for A2A child-task re-entry in
`aoa-sdk`.
...
- one dry-run-only end-to-end fixture at
  `mechanics/checkpoint/parts/child-task-reentry/examples/summon_return_checkpoint_e2e.fixture.json`
