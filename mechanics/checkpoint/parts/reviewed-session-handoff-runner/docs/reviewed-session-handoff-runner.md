...
- `aoa surfaces handoff` is reviewed-only and remains separate from this reviewed session handoff runner.
...
Initial-boundary surface detection is a separate, additive seam.
...
the bounded inbox processor script under
