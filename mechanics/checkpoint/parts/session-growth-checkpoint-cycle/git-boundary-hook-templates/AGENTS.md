...
Local guidance for `mechanics/checkpoint/parts/session-growth-checkpoint-cycle/git-boundary-hook-templates/`.
Read the root `AGENTS.md` and the Checkpoint part cards first. This directory
contains Git hook wrappers for checkpoint and boundary awareness.
