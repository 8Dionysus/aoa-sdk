...
`aoa-sdk` owns the typed live read over deploy-local Codex rollout artifacts.

It does not own rollout authority.

## Inputs

Read from the live workspace root. These filenames are external 8Dionysus
rollout artifact tokens and remain compatibility inputs, not SDK route names:
...
`../../owner-rollout-reference-handoff/docs/deploy-operation-boundary-note.md`
and `../../owner-rollout-reference-handoff/docs/rollout-campaign-refs.md`.
