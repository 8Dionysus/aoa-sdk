...
| validation-evidence-graph | `mechanics/release-support/parts/validation-evidence-graph/`, `scripts/release_check.py`, `.github/workflows/repo-validation.yml`, `evals/suites/aoa-validation-evidence-graph.suite.md` | active; the reviewed three-worker full graph is the default owner gate, the exact serial battery remains rollback, and partial routing/reuse remain non-authoritative |
