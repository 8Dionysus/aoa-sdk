...
The historical routing release-candidate helper is a different route. It binds exact
...
release and stronger-owner records remain external truth. Its builder and
input lock are retained historical replay surfaces, not active release inputs.
