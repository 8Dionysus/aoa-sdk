...
| --- | --- | --- |
| consumed-surface-posture-gate | `mechanics/boundary-bridge/parts/consumed-surface-posture-gate/`, `src/aoa_sdk/compatibility/policy.py`, `src/aoa_sdk/contracts/control_plane.py`, `src/aoa_sdk/artifacts/`, typed facade readers | active; checks consumed sibling posture and owns routing-succession baseline, target-model, and runtime-neutral Agent OS contract evidence |
