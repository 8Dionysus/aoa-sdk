...
selection, repeatability, direct graph identities, legacy migration
compatibility, semantic owner and availability visibility, and preservation
of every unbound guard.
...
distinct trust-record logical and delivered-byte identities, immutable
package delivery of the exact admitted trust record,
...
drift, absent selected scenario, direct graph binding, legacy
migration-owner substitution, entry-route versus contour separation, explicit
versus contour-default approval step
