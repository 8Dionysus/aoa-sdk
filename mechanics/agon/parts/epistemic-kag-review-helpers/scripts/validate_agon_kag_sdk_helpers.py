...
ENTRY_SCHEMA = ROOT / 'schemas/agon-kag-sdk-helper.schema.json'
REGISTRY_SCHEMA = ROOT / 'schemas/agon-kag-sdk-helper-registry.schema.json'
BUILDER = ROOT / 'scripts/build_agon_kag_sdk_helpers.py'
ITEM_KEY = 'sdk_helpers'
REGISTRY_ID = 'agon.kag_sdk_helpers.registry.v1'
SURFACE_ROLE = 'kag_review_helpers'
REVIEW_DOMAIN = 'kag_promotion_path'
