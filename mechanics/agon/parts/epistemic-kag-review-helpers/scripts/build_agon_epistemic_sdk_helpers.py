...
SRC = ROOT / "config" / "agon_epistemic_sdk_helpers.seed.json"
OUT = ROOT / "generated" / "agon_epistemic_sdk_helpers.min.json"
ITEM_KEY = "helpers"
REGISTRY_ID = "agon.epistemic_sdk_helpers.registry.v1"
SURFACE_ROLE = "epistemic_review_helpers"
RUNTIME_POSTURE = "candidate_only"
REQUIRED_SOURCE_FIELDS = ("registry_id", "surface_role", "runtime_posture", ITEM_KEY)
...
def load_source() -> dict[str, Any]:
    ...
    if data["surface_role"] != SURFACE_ROLE:
        raise BuildError(f"surface_role must be {SURFACE_ROLE}")
