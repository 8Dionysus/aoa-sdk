...
REG = PART_ROOT / "generated" / "agon_recurrence_adapter_registry.min.json"
SCHEMA = PART_ROOT / "schemas" / "agon-recurrence-adapter-registry.schema.json"
...
def main() -> int:
    builder = PART_ROOT / "scripts" / "build_agon_recurrence_adapter_registry.py"
