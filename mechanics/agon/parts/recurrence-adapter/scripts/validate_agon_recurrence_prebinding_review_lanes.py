...
RECORD_KEY = 'lanes'
BUILDER = PART_ROOT / 'scripts' / 'build_agon_recurrence_prebinding_review_lanes.py'
...
def load_builder():
    spec = importlib.util.spec_from_file_location('prebinding_review_lanes_builder', BUILDER)
